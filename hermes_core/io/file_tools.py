...
def read_file(data_filename: str) -> TimeSeries:
    ...
    >>> data = read_file('hermes_sunsensor_l1_20220501_000000_v1.0.0.cdf')  # doctest: +SKIP
    """
    ...
    # open the file and extract the data and put it into a TimeSeries (see below for example)
